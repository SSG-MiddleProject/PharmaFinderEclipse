	...
	<div class="container">
		...
		<form class="form" action="findPasswordAf.do" method="post">
			<label for="username"></label> <input type="text" id="username"
				name="username" placeholder="아이디를 입력하세요" required><br>
			<br> <label for="email"></label> <input type="email" id="email"
				name="email" placeholder="이메일을 입력하세요" required><br>
			<br> <input type="submit" value="임시 비밀번호 발급하기">
		</form>
	</div>
</div>
