		...
		function() {
			...
			$('#newPassword, #confirmPassword').keyup(function() {
				...
				if (newPassword === confirmPassword) {
					$('#passwordMatch').css('color', 'blue').text(
							'비밀번호가 일치합니다.');
				} else {
					$('#passwordMatch').css('color', 'red').text(
							'비밀번호가 일치하지 않습니다.');
				}
		});
	});
...
<div class="center">
	<div class="container">
		...
		<form class="form" action="updatePasswordProcess.do" method="post">
			...
			<div>
				<label for="temporaryPassword"></label> <input type="password"
					id="temporaryPassword" name="temporaryPassword"
					placeholder="임시 비밀번호를 입력하세요" required>
			</div>
			<div>
				<label for="newPassword"></label> <input type="password"
					id="newPassword" name="newPassword" placeholder="변경할 비밀번호를 입력하세요"
					required>
			</div>
			<div>
				<label for="confirmPassword"></label> <input type="password"
					id="confirmPassword" name="confirmPassword"
					placeholder="변경할 비밀번호를 확인하세요" required> <span
