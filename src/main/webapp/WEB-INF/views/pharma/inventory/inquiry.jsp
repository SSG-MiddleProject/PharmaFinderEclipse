...
boolean isSearch = searchType != null && !searchType.equals("") && keyword != null && !keyword.equals("");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="wrapper">
		<div class="inner-wrapper">
			<h1 class="title">재고 조회</h1>
				<div class="upper">
				<input type="date" value="${currentDate}" class="input"
					style="width: 20%" onchange="inquiry(this)">
				<form action="/pharma-inventory-inquiry.do">
					<input type="hidden" name="currentDate" value="${currentDate}" />
					<div class="field has-addons has-addons-centered">
						<p class="control">
							<span class="select"> <select id="searchType"
								name="searchType">
	...
	<script type="text/javascript">
		function inquiry(ele) {
			...
			location.href = "/pharma-inventory-inquiry.do?currentDate="
					+ $(ele).val() + "&searchType=" + $("searchType").val()
					+ "&keyword=" + $("keyword").val();
		}
